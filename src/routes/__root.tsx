...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      { charSet: "utf-8" },
      {
        // maximum-scale keeps iOS from zooming in when a chat input is focused
        // (and getting stuck zoomed). The app UI is already responsive.
        name: "viewport",
        content:
      ...
      { name: "apple-mobile-web-app-title", content: "Ashnight" },
