...
export function GroupBookingDialog({ group, onClose }: { group: BookableGroup | null; onClose: () => void }) {
  ...
  const pay = useMutation({ mutationFn: () => {
    if (!group || !activeServiceId) throw new Error("Choose a team service first.");
